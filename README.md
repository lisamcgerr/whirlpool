...
6. Begin your experience by creating a user, followed by logging in. Explore the Whirlpool website by using the navigaton bar (top of the page) and links on each page
